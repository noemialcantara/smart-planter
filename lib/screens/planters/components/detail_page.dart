                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ElevatedButton(onPressed: () {chartTime = 0;},
                                 child: Text('Day')),
                                ElevatedButton(onPressed: () {chartTime = 1;},
                                 child: Text('Week')),
                                ElevatedButton(onPressed: () {chartTime = 2;},
                                 child: Text('Month')),
                              ]
                            ),
                              ...
                              child: SfCartesianChart(//                                    <------------------------------------------------------------------------------- CHART
                                  ...
                                  series: <ChartSeries<ChartData, String>>[
                                    AreaSeries<ChartData, String>(
                                        ...
                                        dataSource: lightChartDataDay, //Chart Data
