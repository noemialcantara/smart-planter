...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/path_provider_ex/path_provider_ex.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/store_launcher/store_launcher.framework"
